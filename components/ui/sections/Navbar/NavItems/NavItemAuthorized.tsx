          ...
          {userImage
            ...
            : <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M30.0837 33.25V30.0833C30.0837 28.4036 29.4164 26.7927 28.2287 25.605C27.0409 24.4173 25.43 23.75 23.7503 23.75H14.2503C12.5706 23.75 10.9597 24.4173 9.77198 25.605C8.58425 26.7927 7.91699 28.4036 7.91699 30.0833V33.25" stroke="#736BEA" strokeWidth={2.5} stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M19.0003 17.4167C22.4981 17.4167 25.3337 14.5811 25.3337 11.0833C25.3337 7.58553 22.4981 4.75 19.0003 4.75C15.5025 4.75 12.667 7.58553 12.667 11.0833C12.667 14.5811 15.5025 17.4167 19.0003 17.4167Z" stroke="#736BEA" strokeWidth={2.5} stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
